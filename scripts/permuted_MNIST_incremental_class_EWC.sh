...
# python -u ../../iBatchLearn.py --repeat $REPEAT --incremental_class --optimizer Adam    --n_permutation 3 --force_out_dim 100 --schedule 3 --batch_size 128 --model_name MLP1000                                                     --lr 0.0001  --offline_training  | tee ${OUTDIR}/Offline.log
...
# python -u   ../../iBatchLearn.py --repeat $REPEAT --incremental_class --optimizer SGD --n_permutation 10 --force_out_dim 100 --schedule 3  --batch_size 128 --model_name MLP1000 --agent_type customization  --agent_name DPMCL_16k  --lr 0.1 --reg_coef 0.5  | tee ${OUTDIR}/DPMCL.log
# python -u   ../../iBatchLearn.py --repeat $REPEAT --incremental_class --optimizer SGD --n_permutation 10 --force_out_dim 100 --schedule 3  --batch_size 128 --model_name MLP1000 --agent_type customization  --agent_name NASH_16k  --lr 0.1 --reg_coef 0.5  | tee ${OUTDIR}/NASH.log
