...
python -u ../iBatchLearn.py --dataset CIFAR100 --train_aug --repeat $REPEAT --optimizer Adam    --force_out_dim 0 --first_split_size 20 --other_split_size 20 --schedule 10 20 30 --batch_size 128 --model_name WideResNet_28_2_cifar --model_type resnet --agent_type customization --agent_name NASH_16k --lr 0.001 --weight_decay 0.001 | tee ${OUTDIR}/NASH_16k.log
# python -u ../iBatchLearn.py --dataset CIFAR100 --train_aug --repeat $REPEAT --optimizer Adagrad    --force_out_dim 0 --first_split_size 20 --other_split_size 20 --schedule 80 120 160 --batch_size 128 --model_name WideResNet_28_2_cifar --model_type resnet --agent_type customization --agent_name DPMCL_16k --lr 0.001 --reg_coef 10              | tee ${OUTDIR}/DPMCL_16k.log