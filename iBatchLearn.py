...
def get_args(argv):
    ...
    ## NASH
    # Comment either of the two blocks.
    ## For MNIST, use these       
    if args.dataset=='MNIST':
        parser.add_argument('--k_range', type=int, default=3, help="kappa updates")
        parser.add_argument('--beta', type=float, default=0.99, help="beta")
        parser.add_argument('--epsilon', type=float, default=0.1, help="step size for x")
        parser.add_argument('--x_updates', type=int, default=2, help="x updates")
        parser.add_argument('--theta_updates', type=int, default=5, help="theta updates")
        parser.add_argument('--internal_batch_size', type=int, default=128, help="batch size")
        parser.add_argument('--lr_theta', type=float, default=0.001, help="batch size")   
    elif args.dataset =='CIFAR100':
        ## For CIFAR100, use these       
        parser.add_argument('--k_range', type=int, default=1, help="kappa updates")
        parser.add_argument('--beta', type=float, default=0.99, help="beta")
        parser.add_argument('--epsilon', type=float, default=1e-03, help="step size for x")
        parser.add_argument('--x_updates', type=int, default=1, help="x updates")
        parser.add_argument('--theta_updates', type=int, default=1, help="theta updates")
        parser.add_argument('--internal_batch_size', type=int, default=128, help="batch size")
        parser.add_argument('--lr_theta', type=float, default=1e-05, help="batch size")  
...
def run(args):
    ...
    agent_config = {
                    'k_range':args.k_range, 'beta':args.beta,
                    'epsilon':args.epsilon, 'x_updates':args.x_updates,
                    'theta_updates':args.theta_updates, 'internal_batch_size':args.internal_batch_size,
                    'lr_theta':args.lr_theta, 'lr': args.lr, 'momentum': args.momentum, 'weight_decay': args.weight_decay,
